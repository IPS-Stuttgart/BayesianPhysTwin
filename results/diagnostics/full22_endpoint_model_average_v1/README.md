...
- Hosted per-case CSV SHA-256: `19184cfefe707ed49739a18ee667402cfea24b46297f0217d2edcd85d5fc3b31`
- Repository LF per-case CSV SHA-256: `ac37b5004987f94145dbca6ea8e08d60582f4fac323a5b5ae9cdcaa578eafa1d`
- Pre-target gates: Ruff, formatting, 48 focused tests, protocol digest, and package consistency all passed.

The hosted artifact was emitted with CSV `CRLF` row endings, whereas Git normalized the committed snapshot to `LF`. Reconstructing `CRLF` from the committed rows reproduces the hosted manifest hash exactly. Both byte identities are retained above, and the evaluator now emits `LF` explicitly.
