"""Baseline-relative posterior chance guard for native wrapping."""
...
WORLD_COUNT = 72
PREFIX_BATCH_COUNT = 8
SENSOR_DRAWS = 4096
WORLD_SEED = 261710
SENSOR_SEED = 261711
BOOTSTRAP_SEED = 261712
...
def protocol() -> dict[str, Any]:
    ...
    return {
        "schema": "dlolab-wrapping-risk-guard-source-v4",
        ...
        "worlds_disjoint_from_source_failed_v1_development_v2_and_v3": True,
        ...
        "pre_future_gate": {
            "all_eight_prefix_batches_native_qualified": True,
        ...
        "source_gate": {
            "all_72_worlds_and_native_qa": True,
...
def pre_future_checks(
    ...
    *,
    ...
    checks = {
        "all_eight_prefix_batches_native_qualified": bool(all_prefix_qa),
...
def score(decisions: Array, rewards: Array, *, all_native_qa: bool) -> dict[str, Any]:
    ...
    checks = {
        "complete_72_world_denominator": True,
    ...
    return {
        "schema": "dlolab-wrapping-risk-guard-score-v4",
        "arms": arms,
