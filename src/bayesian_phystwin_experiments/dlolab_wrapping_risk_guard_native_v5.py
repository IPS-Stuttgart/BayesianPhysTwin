"""Runtime-hardened CPU execution for the wrapping chance-guard lineage."""
...
def _initialize(
    ...
    if set(captured) != {"bending", "stretching"}:
        raise RuntimeError("native material realization was not captured")
...
def run_worlds(
    ...
    *,
    ...
    try:
        ...
        if len(trace) != expected_steps or len(initial) != 1:
