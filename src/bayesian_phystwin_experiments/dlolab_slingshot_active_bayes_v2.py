...
def protocol() -> dict[str, Any]:
    return {
        "schema": "dlolab-slingshot-active-bayes-source-v2",
        "role": "fresh_successor_test_after_terminal_pre_science_v1_runtime_failure",
        "v1_retried": False,
        "v1_scientific_result": False,
        "v1_result_id": "ba3d015ad95806f040c88b0f8548ee238edbef0ebbcc0b1fe1b4858d91547e5b",
        "runtime_preflight_result_id": "53ab35dce6629dd1b2ab2b28e6756e14cd6100bc50bba46e45d02f71023aac25",
...
def score(decisions: Array, rewards: Array, *, all_native_qa: bool) -> dict[str, Any]:
    ...
    return {
        "schema": "dlolab-slingshot-active-bayes-score-v2",
        "arms": arms,
