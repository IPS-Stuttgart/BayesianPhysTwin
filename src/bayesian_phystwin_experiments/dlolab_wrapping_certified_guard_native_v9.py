"""Native-Linux execution adapter for the v9 wrapping replication."""
...
from .dlolab_wrapping_certified_guard_v9 import validate_continuous_world
...
def run_worlds(
    ...
    *,
    ...
    """Run the unchanged physical workload for the v9 replication."""
