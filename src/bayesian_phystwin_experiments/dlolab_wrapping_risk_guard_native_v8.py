"""Native-Linux execution adapter for the v8 wrapping replication."""
...
from .dlolab_wrapping_risk_guard_v8 import validate_continuous_world
...
def run_worlds(
    ...
    *,
    ...
    """Run the unchanged physical workload for the v8 replication."""
