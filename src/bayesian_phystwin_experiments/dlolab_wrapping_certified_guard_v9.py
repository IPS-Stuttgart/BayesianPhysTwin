"""Prospective native-Linux replication of the wrapping certified guard."""
...
from .dlolab_wrapping_risk_guard_v8 import continuous_worlds as calibration_v8_worlds
...
CALIBRATION_V8_RESULT_ID = (
    "61c97165b9277790ac0e4e5374659fb9eab598dc0ff96ef3503859d6198ae5b2"
)
CALIBRATION_CONFIDENCE = 0.95
HARM_RISK_BUDGET = 0.05
CALIBRATION_HARM_COUNT = 2
CALIBRATION_WORLD_COUNT = 144
CALIBRATION_HARM_RISK_UPPER = 0.04307319681566585
CALIBRATION_CERTIFICATE_ID = (
    "790bc9facc33838bf32b64e232e10f8012035cd53f1f8880d629f7fdf06714c2"
)
...
def clopper_pearson_upper(
    ...
    *,
    ...
    if (
        type(harm_count) is not int
        or type(world_count) is not int
        or not 0 <= harm_count <= world_count
        or world_count < 1
        or type(confidence) is not float
        or not 0 < confidence < 1
    ):
        raise ValueError("valid binomial confidence-bound inputs required")
    if harm_count == world_count:
        return 1.0
    ...
    def cumulative(probability: float) -> float:
        return float(
            sum(
                math.comb(world_count, index)
                * probability**index
                * (1.0 - probability) ** (world_count - index)
                for index in range(harm_count + 1)
            )
        )
...
def protocol() -> dict[str, Any]:
    ...
    calibration_v8_keys = {
        ...
        for row in calibration_v8_worlds()
    }
    if (
        ...
        or new_keys & calibration_v8_keys
    ):
        raise ValueError("fresh wrapping risk-stress roster changed")
    return {
        "schema": "dlolab-wrapping-risk-certified-guard-source-v9",
        "role": "prospective_public_simulator_risk_certificate_replication",
        ...
        "calibration_v8_strict_source_gate_passed": False,
        "calibration_v8_strict_gate_reclassified": False,
        "calibration_v8_used_for_risk_certification": True,
        "calibration_certificate_id": CALIBRATION_CERTIFICATE_ID,
        "calibration_certificate": {
            "statistical_unit": "independent_public_simulator_world",
            "worlds": CALIBRATION_WORLD_COUNT,
            "harm_count": CALIBRATION_HARM_COUNT,
            "harm_event": "world_mean_reward_below_fixed_by_more_than_0_002",
            "confidence": CALIBRATION_CONFIDENCE,
            "risk_budget": HARM_RISK_BUDGET,
            "one_sided_exact_binomial_upper": CALIBRATION_HARM_RISK_UPPER,
            "passed": CALIBRATION_HARM_RISK_UPPER <= HARM_RISK_BUDGET,
            "threshold_selected_from_calibration_v8_outcomes": False,
        ...
        "method_class_changed_from_v8": True,
        "action_policy_changed_from_v8": False,
        "method": "finite_sample_certify_or_exact_fallback_posterior_guard",
        ...
        "study_level_fallback_if_certificate_fails": (
        ...
        "world_distribution": {
            "kind": "v8_calibration_matched_action_transition_stress_panel",
        ...
        "worlds_disjoint_from_source_v1_v2_v3_terminal_v4_and_calibration_v8": True,
        ...
        "primary_hypothesis": (
            "a_v8_certified_guard_has_positive_value_and_a_95pct_upper_harm_risk_bound_at_most_0_05"
        ),
        ...
        "pre_future_gate": {
            "calibration_certificate_revalidated": True,
            "all_thirty_two_prefix_batches_native_qualified": True,
        ...
        "source_gate": {
            ...
            "guard_gain_over_best_fixed_at_least": 0.003,
            "positive_paired_ci95_vs_fixed": True,
            "guard_one_sided_95pct_harm_risk_upper_at_most": HARM_RISK_BUDGET,
            "continuous_bayes_harmed_worlds_at_least": 10,
            "guard_reduces_harmed_worlds_by_at_least": 5,
            "guard_reduces_mean_downside_vs_continuous_by_fraction": 0.75,
            "guard_retains_at_least_fraction_of_continuous_gain": 0.15,
        ...
        "calibration_v8_threshold_sweep_used_for_v9_selection": False,
...
def pre_future_checks(
    ...
    *,
    all_prefix_qa: bool,
    calibration_certificate_valid: bool,
) -> dict[str, Any]:
    ...
    checks = {
        "calibration_certificate_revalidated": bool(calibration_certificate_valid),
        "all_thirty_two_prefix_batches_native_qualified": bool(all_prefix_qa),
...
def score(
    ...
    *,
    ...
    for index, name in enumerate(ARM_NAMES):
        ...
        harmed = int(np.count_nonzero(gain < -REWARD_MARGIN))
        arms[name] = {
            ...
            "worlds_harmed_beyond_numeric_margin": harmed,
            "observed_harm_fraction": float(harmed / WORLD_COUNT),
            "one_sided_95pct_harm_risk_upper": clopper_pearson_upper(
                harmed,
                WORLD_COUNT,
                confidence=CALIBRATION_CONFIDENCE,
            ),
    ...
    guard_harm_risk_upper = arms["posterior_975_guard"][
        "one_sided_95pct_harm_risk_upper"
    ]
    checks = {
        ...
        >= 2,
        "guard_gain_over_best_fixed_at_least_0_003": gain >= 0.003,
        "positive_paired_ci95_vs_fixed": paired["continuous_prior_best_fixed"]["ci95"][
            0
        ]
        > 0,
        "guard_one_sided_95pct_harm_risk_upper_at_most_0_05": (
            guard_harm_risk_upper <= HARM_RISK_BUDGET
        ),
        "continuous_bayes_harmed_worlds_at_least_10": continuous_harms >= 10,
        "guard_reduces_harmed_worlds_by_at_least_5": harmed_reduction >= 5,
        "guard_reduces_mean_downside_vs_continuous_by_at_least_75pct": (
            downside_reduction >= 0.75
        ),
        "guard_retains_at_least_15pct_continuous_gain": retained >= 0.15,
        "captures_at_least_5pct_oracle_headroom": fraction >= 0.05,
    }
    return {
        "schema": "dlolab-wrapping-risk-certified-guard-score-v9",
        "arms": arms,
        ...
        "guard_observed_harm_fraction": float(guard_harms / WORLD_COUNT),
        "guard_one_sided_95pct_harm_risk_upper": guard_harm_risk_upper,
        "registered_harm_risk_budget": HARM_RISK_BUDGET,
        "harm_risk_confidence": CALIBRATION_CONFIDENCE,
