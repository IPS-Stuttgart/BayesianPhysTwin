...
_STABLE_COMMANDS: Final[tuple[CommandSpec, ...]] = (
    ...
    CommandSpec(
        command_id="proper-scoring",
        route=("evidence", "score"),
        previous_routes=(),
        module="bayesian_phystwin.cli.proper_scoring",
        function="main",
        description="convert predictive distributions into proper-score evidence",
        legacy_alias=None,
        status=CommandStatus.STABLE,
        optional_dependencies=(),
        owner="bayesian-phystwin-proper-scoring-v1",
        documentation="docs/proper_scoring.md",
    ),
    CommandSpec(
        command_id="bayesian-value-decomposition",
        route=("evidence", "decompose"),
        previous_routes=(),
        module="bayesian_phystwin.cli.value_decomposition",
        function="main",
        description="decompose guarded Bayesian value across frozen comparison arms",
        legacy_alias=None,
        status=CommandStatus.STABLE,
        optional_dependencies=(),
        owner="bayesian-phystwin-bayesian-value-decomposition-v1",
        documentation="docs/bayesian_value_decomposition.md",
    ),
    CommandSpec(
