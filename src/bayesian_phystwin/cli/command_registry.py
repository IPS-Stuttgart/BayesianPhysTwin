...
_STABLE_COMMANDS: Final[tuple[CommandSpec, ...]] = (
    ...
    CommandSpec(
        command_id="recursive-corruption-benchmark",
        route=("benchmark", "recursive-corruption"),
        previous_routes=(),
        module="bayesian_phystwin.cli.recursive_corruption_benchmark",
        function="main",
        description="run the controlled recursive corruption benchmark",
        legacy_alias=None,
        status=CommandStatus.STABLE,
        optional_dependencies=(),
        owner="recursive-corruption-benchmark-v1",
        documentation="docs/recursive_corruption_benchmark.md",
    ),
    CommandSpec(
