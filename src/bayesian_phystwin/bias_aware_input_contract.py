...
from .bias_aware_belief import BiasAwareStateUpdateConfig, BiasAwareStateUpdateResult
from .bias_aware_belief import update_bias_aware_state as _update_bias_aware_state_v1
...
def _strict_boolean_array(value: object, *, name: str) -> np.ndarray:
    ...
    if raw.dtype.kind not in "iuf":
        raise ValueError(f"{name} must contain booleans or exact 0/1 numeric values")
