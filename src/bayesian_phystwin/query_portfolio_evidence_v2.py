"""Portable component evidence for the v5 portfolio recovery."""
...
from .query_portfolio_replication_v5 import protocol, score
...
def component_evidence(
    ...
    *,
    ...
    """Serialize one complete query denominator under the v5 lock."""
...
def load_component_evidence(value: Mapping[str, Any]) -> QueryOutcomeV1:
    """Validate a v5 component record and recover its immutable outcome."""
    ...
    if (
        ...
        raise ValueError("invalid v5 portfolio component evidence")
...
def assemble(records: Mapping[str, Mapping[str, Any]]) -> dict[str, Any]:
    """Assemble the complete v5 two-query familywise certificate."""
    ...
    value: dict[str, Any] = {
        **result,
        "schema": "bayesian_phystwin.query_portfolio_replication.result_evidence_v2",
        "component_evidence": {
            key: {
