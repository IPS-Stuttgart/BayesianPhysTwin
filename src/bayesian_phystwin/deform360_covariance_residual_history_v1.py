"""Source-only residual-history dry run for a future covariance study.
...
fallback objects whenever support or covariance admission fails. Target roster,
custody, prediction, and outcome authorization belong to a separately reviewed
protocol and are intentionally not part of this source-only interface.
"""
