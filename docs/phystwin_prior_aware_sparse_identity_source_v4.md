# Prior-aware sparse-identity state update: source smoke v4
...
v1-v3. Every predecessor is archived and must not be rerun or scored.
...
V4 requires bit-exact selected-baseline replay parity and persists the complete
...
`configs/sota/phystwin_prior_aware_sparse_identity_source_v4.json`.
...
PYTHONPATH=/home/florianpfaff/bpt-prior-aware-sparse-identity-v1/runtime-warp111:src \
  ...
  --protocol configs/sota/phystwin_prior_aware_sparse_identity_source_v4.json \
  --output /home/florianpfaff/bpt-prior-aware-sparse-identity-v4/run/single_lift_cloth
```
