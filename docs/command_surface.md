...
A stable command may be grouped-only. For example, `bpt evidence summarize` has
no additional console-script alias and therefore demonstrates the extension
policy for new interfaces.
