#!/usr/bin/env python3
"""Run the permit-gated held-v5 Deform360 calibration outcome phase.
...
def _verify_locked_deployment(arguments: "DriverArguments") -> Path:
    ...
    expected_driver = operator_dir / "run_deform360_v5_calibration_outcomes.py"
...
def _execute_driver(
    ...
    _require(len(expected_cases) == 15, "held-v5 calibration cohort is not 15 cases")
...
def _parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            ...
            "exact held-v5 15-case calibration cohort."
        )
    )
