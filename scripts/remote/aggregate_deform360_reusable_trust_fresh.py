#!/usr/bin/env python3
"""Apply the locked fresh reusable-twin admission gate."""
...
def main() -> int:
    ...
    payload = aggregate_reusable_trust_fresh_gate(
    ...
    if args.output.exists():
        raise FileExistsError(f"admission gate already exists: {args.output}")
