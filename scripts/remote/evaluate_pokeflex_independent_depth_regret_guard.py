#!/usr/bin/env python3
"""Fit and cross-object evaluate the PokeFlex D405 regret guard."""
...
def main() -> None:
    ...
    result = evaluate_pokeflex_regret_guard_cross_object(payloads)
    ...
    if args.output.exists() and args.output.read_text(encoding="utf-8") != rendered:
        raise ValueError(f"existing evaluation differs: {args.output}")
