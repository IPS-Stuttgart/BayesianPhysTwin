#!/usr/bin/env python3
"""Recover official Deform360 alignment and robot state for one queued source."""
...
def main() -> int:
    args = _parse_args()
    protocol, queue, download = validate_window_sources(
    ...
    manifest: dict[str, Any] = {
        "schema_version": 1,
        "artifact_kind": "Deform360FreshSourcePreparation",
