#!/usr/bin/env python3
"""Materialize one queue-bound dynamic TAPNext++ source window."""
...
def main() -> int:
    args = _parse_args()
    protocol, queue, _ = validate_dynamic_window_sources(
    ...
    selection_seal = seal_dynamic_source_window_selection(
        protocol=protocol,
        case=case,
        selection=selection,
    ...
    try:
        ...
        stage["result_sha256"] = canonical_sha256(stage, digest_key="result_sha256")
