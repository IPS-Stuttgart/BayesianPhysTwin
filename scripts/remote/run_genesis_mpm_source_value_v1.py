#!/usr/bin/env python3
"""Run the frozen Genesis source-value prediction and outcome gates."""
...
def main() -> int:
    ...
    if args.command == "predict":
        result = generate_genesis_source_value_predictions_v1(
        ...
        result = score_genesis_source_value_prefix_v1(
            protocol_path=args.protocol,
            group_roots=roots,
            matphys_paths=_bindings(args.matphys),
        ...
        result = score_genesis_source_value_future_v1(
            protocol_path=args.protocol,
            group_roots=roots,
            matphys_paths=_bindings(args.matphys),
