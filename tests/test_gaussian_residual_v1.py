...
def test_nested_splits_keep_recordings_and_holdout_separate():
    from run_gp_residual_development_v1 import build_splits
...
def test_source_manifest_rejects_eval_and_overlap():
    from run_gp_residual_development_v1 import validate_source_manifest
...
from run_gp_residual_development_v1 import install_payload_guard
...
def test_selection_deterministic_and_invalid_predictions_fail():
    from run_gp_residual_development_v1 import select_strength
