...
def test_repository_manifest_expands_deterministically() -> None:
    ...
    assert {
        ...
        "tests/test_matphys_native_source_v1.py",
        ...
        "tests/test_rgbench_matphys_source_v1.py",
        "tests/test_rgbench_matphys_technical_smoke_plan_v1.py",
        "tests/test_controlled_query_competence_v1.py",
        "tests/test_controlled_query_competence_runners_v1.py",
