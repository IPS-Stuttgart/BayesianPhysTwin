...
See [Decisive evidence protocol](docs/decisive_evidence_protocol.md) for the
fail-closed input contract, matched risk–coverage analysis, tail regressions,
...
- [Decisive evidence protocol](docs/decisive_evidence_protocol.md)
